      ...
      child: Consumer<WeatherModel>(
        builder: (context, weather, child) {
          if (weather.today.radar == null ||
              weather.today.radar.overlays.length == 0) {
            return Container();
          }
          ...
          LatLng center = new LatLng(weather.today.radar.location.latitude,
                      ...
                      overlayImages: [
                        new OverlayImage(
                          bounds: new LatLngBounds(
                            new LatLng(weather.today.radar.mapMin.latitude,
                                weather.today.radar.mapMin.longitude),
                            new LatLng(weather.today.radar.mapMax.latitude,
                ...
                children: <Widget>[
                  TextButton(
                    ...
                    style: TextButton.styleFrom(
                        backgroundColor: _mapController.ready &&
                                _mapController.zoom == 9
