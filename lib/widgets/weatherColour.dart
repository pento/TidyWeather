...
Color weatherColor( BuildContext context, String weatherCode ) {
  ...
  weatherCodes[ 'chance-shower-cloud' ] = Colors.blueGrey.shade400;
  weatherCodes[ 'chance-shower-fine' ] = Colors.green.shade500;
...
//  weatherCodes[ 'cloudy' ] = 'weather_cloudy';
  weatherCodes[ 'drizzle' ] = Colors.blueGrey.shade300;
//  weatherCodes[ 'dust' ] = 'weather_hazy';
  weatherCodes[ 'few-showers' ] = Colors.blueGrey.shade400;
//  weatherCodes[ 'fine' ] = 'weather_fine';
...
//  weatherCodes[ 'mostly-cloudy' ] = 'weather_cloudy';
  weatherCodes[ 'mostly-fine' ] = Colors.green.shade500;
//  weatherCodes[ 'overcast' ] = 'weather_cloudy';
  weatherCodes[ 'partly-cloudy' ] = Colors.lightBlue;
  weatherCodes[ 'shower-or-two' ] = Colors.green.shade500;
  weatherCodes[ 'showers-rain' ] = Colors.blueGrey.shade400;
